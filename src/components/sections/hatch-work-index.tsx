      ...
      <div className="section-padding container">
        <div className="mx-auto w-full">
          ...
          <p className="text-muted-foreground mt-4 text-sm leading-[1.7] sm:text-base">
            Une sélection de réalisations et d'accompagnements qui mettent en
            avant une approche structurée, concrète et orientée impact.
          </p>
        </div>
        ...
        <div className="mt-12 flex items-center justify-between gap-4">
          <p className="text-muted-foreground text-sm">
            Affichage de {Math.min(visible, items.length)} sur {items.length}
          </p>
          ...
          {canLoadMore ? (
            ...
            >
              <a href="/contact">
                Échangeons ensemble <ArrowRight className="ml-1 size-4" />
              </a>
            </Button>
          )}
        </div>
